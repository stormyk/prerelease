...
void CH3View::OnMButtonDown(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default

	CView::OnMButtonDown(nFlags, point);
	mouse(1, 0, point.x, point.y, nFlags & MK_SHIFT, nFlags & MK_CONTROL);
	drag = 1;
}

void CH3View::OnMButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	
	CView::OnMButtonUp(nFlags, point);
	mouse(1, 1, point.x, point.y, nFlags & MK_SHIFT, nFlags & MK_CONTROL);
	drag = 0;
}
...
void CH3View::OnSize(UINT nType, int cx, int cy) 
{
    ...
    // mucks up the circle here

	resize(cx, cy);
	//keyboard('K');keyboard('K'); //sjk-2011 keeping the shape
}
